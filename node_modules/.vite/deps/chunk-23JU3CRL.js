...
function areChildrenDifferent(oldChildren, newChildren) {
  ...
  if (import_react3.default.isValidElement(oldChildren) && import_react3.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react3.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react3.default.cloneElement(children, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react3.default.cloneElement(children, {
    in: true,
    onEntered: callHook(children, "onEntered", function() {
      changeState(ENTERED, import_react3.default.cloneElement(children, {
        in: true
      }));
    })
  });
...
var SwitchTransition = (function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react3.default.cloneElement(props.children, {
        in: true
      })
    };
  };
...
//# sourceMappingURL=chunk-23JU3CRL.js.map
